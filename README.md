...
Together with the [Text Quest Editor](https://github.com/albruevich/Text-Quest-Editor) tool, it forms a system for creating and running custom text quests.
...
⚠️ This structure is automatically generated by the Text Quest Editor. You do NOT need to create it manually.
...
Quests are created using a separate tool — [Text Quest Editor](https://github.com/albruevich/Text-Quest-Editor).
